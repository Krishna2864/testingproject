...
###
  path('locallist/',views.localList,name="local_list"),
    path('localdetail/<int:id>/',views.localDetail,name="local_detail"),
    path('localcreate/',views.localCreate,name="local_create"),
    path('localupdate/<int:id>/',views.localUpdate,name="local_update"),
    path('localdelete/<int:pk>/',views.localDelete,name="local_delete"),

###
  path('employeelist/',views.employeeList,name="employee_list"),
    path('employeeedetail/<int:id>/',views.employeeDetail,name="employee_detail"),
    path('employeecreate/',views.employeeCreate,name="employee_create"),
    path('employeeupdate/<int:id>/',views.employeeUpdate,name="employee_update"),
    path('employeedelete/<int:pk>/',views.employeeDelete,name="employee_delete"),

###
  path('employeetransportationlist/',views.employeetransportationList,name="employeetransportation_list"),
    path('employeetransportationdetail/<int:id>/',views.employeetransportationDetail,name="employeetransportation_detail"),
    path('employeetransportationcreate/',views.employeetransportationCreate,name="employeetransportation_create"),
    path('employeetransportationupdate/<int:id>/',views.employeetransportationUpdate,name="employeetransportation_update"),
    path('employeetransportationdelete/<int:pk>/',views.employeetransportationDelete,name="employeetransportation_delete"),

   

###
  path('outstationlistsecond/',views.outstationlistsecond,name="outstation_listsecond"),
    path('outstationdetailsecond/<int:id>/',views.outstationdetailsecond,name="outstation_detailsecond"),
    path('outstationcreatesecond/',views.outstationcreatesecond,name="outstation_createsecond"),
    path('outstationupdatesecon/<int:id>/',views.outstationupdatesecond,name="outstation_updatesecond"),
    path('outstationdelete/<int:pk>/',views.outstationDeletesecond,name="outstation_deletesecond"),

###
  path('locallistsecond/',views.localListsecond,name="local_listsecond"),
    path('localdetailsecond/<int:id>/',views.localDetailsecond,name="local_detailsecond"),
    path('localcreatesecond/',views.localCreatesecond,name="local_createsecond"),
    path('localupdatesecond/<int:id>/',views.localUpdatesecond,name="local_updatesecond"),
    path('localdeletesecond/<int:pk>/',views.localDeletesecond,name="local_deletesecond"),
