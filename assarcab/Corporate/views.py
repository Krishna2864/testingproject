...
##dropup
from .models import  dropup_Points_Management
from .serializers import  dropup_Points_ManagementSerailizer
@api_view(['GET'])
...
################################
from .models import Templates_Management,OUTSTATION,LOCAL,EMPLOYEE_TAXI,EMPLOYEE_TRANSPORTATION_Second
from .serializers import Templates_ManagementSerailizer,OUTSTATIONSerailizer,LOCALSerailizer,EMPLOYEE_TAXISerailizer,EMPLOYEE_TRANSPORTATION_SecondSerailizer
...
from .models import OUTSTATION_Second , LOCAL_Second
from .serializers import OUTSTATION_SecondSerailizer ,LOCAL_SecondSerailizer
...
def outstationlistsecond(request):
    ...
    if admin1 is None:
      ...
      serializer=FOUTSTATION_SecondSerailizer(admin1,many=True)
    return JsonResponse({'result':serializer.data},safe=False)
@api_view(['GET'])
